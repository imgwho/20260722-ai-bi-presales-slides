...
size: 16:9
style: |
  section { font-family: "Microsoft YaHei", "PingFang SC", Arial, sans-serif; color: #172033; background: #f8fafc; }
  h1 { color: #0f766e; }
  h2 { color: #334155; }
  li { margin: 8px 0; }
...
- 典型需求：做个看板、做个大屏、做个仪表盘
- 这些词都指向“展示”，而不是“业务目标”
- BI 项目从立项那一刻起就被框死在“可视化”层
