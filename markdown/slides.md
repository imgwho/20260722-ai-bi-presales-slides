...
<div class="evidence-layout">
  <figure><img src="../Images/evidence/cwtwb-hero.png" alt="cwtwb 界面截图"><figcaption>真实运行界面：AI 调用 MCP 工具生成布局、仪表板与交互</figcaption></figure>
  <div>
...
<div class="evidence-layout">
  <figure><img src="../Images/evidence/cwprep-hero.png" alt="cwprep 界面截图"><figcaption>真实运行界面：AI 设计并生成可在 Tableau Prep 中继续编辑的流程</figcaption></figure>
  <div>
